...
- [ ] 3.3 Prevent draft rerenders from moving an active Remove control before its interaction completes and add regression coverage

## 4. Cancellation Safety

- [ ] 4.1 Add an accessible confirmation step before sending an assigned-occurrence cancellation
...
- [ ] 5.3 Browser-verify own-data isolation, keyboard editing, save feedback and position retention, exception withdrawal, cancellation confirmation, successful backup promotion, and no-backup or downstream-failure messaging
