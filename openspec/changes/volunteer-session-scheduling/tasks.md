...
- [ ] 10.20 Reconsider the centre user's view once an interval is confirmed: a confirmed candidate keeps its row among the proposals even though the decision is made and its occurrence now lives in the schedule, and the user asked for a calendar-style view of sessions with monthly and weekly options for the centre user rather than a flat list tied to the workbook's raw fields
